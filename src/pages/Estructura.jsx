      ...
      <main className="grow pt-24 pb-24 px-6 max-w-7xl mx-auto w-full">
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20 items-center">
          <div className="lg:col-span-7">
            ...
            >
              MÁXIMA <span className="text-transparent bg-clip-text bg-linear-to-brrom-[#ffb68b] to-[#ff7a00]">PRECISIÓN</span> <br />DENTAL_OS
            </motion.h1>
            <motion.p
            ...
            >
              <Link to="/turnos">
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="bg-linear-to-br from-[#ffb68b] to-[#ff7a00] px-8 py-4 text-[#321200] font-black text-sm uppercase tracking-widest flex items-center gap-3 rounded shadow-lg shadow-[#ff7a00]/20">
                  COMENZAR AHORA
                  <ArrowRight size={18} />
                </motion.button>
              </Link>
          ...
          <div className="lg:col-span-5 relative">
            <div className="aspect-square bg-[#2a2a2a]/40 backdrop-blur-md rounded-xl overflow-hidden relative border border-[#584235]/30 shadow-2xl">
              ...
              <div className="absolute inset-0 bg-linear-to-trom-[#131313] via-transparent to-transparent"></div>
        ...
        <section className="mt-32 pt-16 border-t border-[#584235]/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-linear-to-b from-[#1c1b1b] to-transparent p-px rounded-2xl group cursor-pointer hover:shadow-[0_0_40px_-15px_rgba(255,122,0,0.3)] transition-all duration-500">
            ...
            <div className="bg-linear-to-b from-[#1c1b1b] to-transparent p-px rounded-2xl group cursor-pointer hover:shadow-[0_0_40px_-15px_rgba(255,122,0,0.3)] transition-all duration-500 relative mt-0 md:-mt-8">
              <div className="absolute inset-0 bg-linear-to-br from-[#ff7a00]/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
            ...
            <div className="bg-linear-to-brom-[#1c1b1b] to-transparent p-px rounded-2xl group cursor-pointer hover:shadow-[0_0_40px_-15px_rgba(255,122,0,0.3)] transition-all duration-500">
              <div className="bg-[#131313] h-full p-8 rounded-[15px] group-hover:bg-[#1a1919] transition-colors">
                <div className="w-12 h-12 bg-[#ff7a00]/10 rounded-xl flex items-center justify-center mb-6 border border-[#ff7a00]/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-12 md:p-20 relative z-10 flex flex-col justify-center">
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-6 leading-tight">
                BIENVENIDO A <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-[#ffb68b] to-[#ff7a00]">OBSIDIAN_CORE</span>
              </h2>
            ...
            <div className="relative p-12 lg:p-0 flex items-center justify-center lg:justify-end overflow-hidden">
              <div className="bg-[#131313] rounded-t-3xl rounded-b-0 lg:rounded-l-3xl lg:rounded-r-0 lg:rounded-none w-full max-w-sm h-full lg:h-auto min-h-[400px] border-t border-l border-[#584235]/30 relative z-10 p-6 shadow-2xl flex flex-col gap-4 transform rotate-0 lg:translate-x-6 lg:translate-y-6 mt-12 lg:mt-0">
                ...
                <div className="bg-[#1c1b1b] rounded-xl p-5 border border-[#584235]/20 grow shadow-inner relative overflow-hidden group">
