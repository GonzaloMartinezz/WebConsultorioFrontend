    ...
    <div className="min-h-screen bg-[#FFFBF7] pt-28 pb-12 px-4 sm:px-6 lg:px-8 flex justify-center">
      <div className="w-full max-w-7xl flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-8">
          ...
          {/* Hero del Portal */}
          <div className="bg-[#4A3B32] rounded-[2rem] p-10 md:p-14 relative overflow-hidden text-white shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-secondary/10">
        ...
        <div className="w-full lg:w-80 space-y-6">
          ...
          {/* Estado de Cuenta */}
          <div className="bg-white p-8 rounded-[2rem] border border-secondary/10 shadow-sm">
