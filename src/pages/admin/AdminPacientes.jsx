                ...
                <tr key={paciente.id} className="border-b border-secondary/20 hover:bg-secondary/10 transition-colors group">
                  ...
                  <td className="px-6 py-5 text-right">
                    <div className="flex items-center justify-end gap-3 opacity-70 group-hover:opacity-100 transition-opacity">
                      ...
                      <Link to={`/admin/odontograma-avanzado/${paciente.id}`} className="text-accent-orange hover:text-orange-600 bg-orange-50 p-2 rounded-lg hover:scale-110 transition-transform" title="Odontograma">
                        <FaTooth className="text-lg" />
                      </Link>
                      <Link to={`/admin/historia-clinica/${paciente.id}`} className="text-primary hover:text-primary/70 bg-primary/10 p-2 rounded-lg hover:scale-110 transition-transform" title="Historia Clínica">
