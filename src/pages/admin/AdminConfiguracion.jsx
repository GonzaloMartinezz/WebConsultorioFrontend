    ...
    <LayoutAdmin>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-[1fr,1.5fr] gap-8 pb-10" data-aos="fade-up">
        ...
        <section className="space-y-6">
          <div className="bg-white rounded-4xl p-8 shadow-sm border border-secondary flex flex-col gap-6">
        ...
        <section>
          <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-secondary flex flex-col gap-6 relative border-l-8">
