      ...
      <section className="mb-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {stats.map((stat, index) => {
          ...
          return (
            <div 
              key={index} 
              className="bg-white rounded-[2rem] p-8 shadow-sm border border-secondary flex items-center gap-6 hover:border-accent-orange transition-colors duration-300 transform hover:-translate-y-1 hover:shadow-lg"
            >
