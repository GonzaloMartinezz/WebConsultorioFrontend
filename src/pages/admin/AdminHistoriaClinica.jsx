    ...
    return (
        <LayoutAdmin>
            <main className="grid grid-cols-1 xl:grid-cols-[300px_1fr] gap-6" data-aos="fade-up">
                ...
                <aside className="bg-white rounded-[2rem] p-6 shadow-sm border border-secondary/50 flex flex-col items-center">
                    <div className="w-32 h-32 bg-blue-100 rounded-[2rem] flex items-center justify-center text-blue-500 mb-4 shadow-inner">
                        ...
                        <div className="bg-white rounded-3xl p-6 shadow-sm border border-secondary/50">
                            ...
                            <div className="space-y-3 mb-6">
                                <div className="flex justify-between text-sm font-medium items-center">
                                    <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-primary flex-shrink-0"></div> Profilaxis (1)</span> <span>$250</span>
                                </div>
                                <div className="flex justify-between text-sm font-medium items-center">
                                    <span className="flex items-center gap-2"><div className="w-2 h-2 rounded-full border border-primary flex-shrink-0"></div> Blanqueamiento (1)</span> <span>$100</span>
                                </div>
                            </div>
