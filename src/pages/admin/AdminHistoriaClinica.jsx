  ...
  return (
    <LayoutAdmin>
      <div className="max-w-[1400px] mx-auto flex flex-col h-[calc(100vh-140px)] gap-5">
        ...
        <div className="bg-white p-4 rounded-4xl shadow-sm border border-secondary/10 shrink-0 relative z-20 flex flex-col md:flex-row gap-4 items-center">
        ...
        {cargando ? (
          ...
          <div className="flex-1 flex flex-col xl:flex-row gap-5 min-h-0 animate-fade-in">
            ...
            <div className="w-full xl:w-[280px] bg-white rounded-4xl shadow-sm border border-secondary/10 overflow-hidden shrink-0">
              <div className="bg-linear-to-br from-primary to-[#3a2e25] p-5 md:p-6 text-white relative overflow-hidden">
              ...
              <div className="p-4 md:p-5 space-y-3 overflow-y-auto custom-scrollbar max-h-[300px] xl:max-h-none">
                ...
                {pacienteActivo.estado && (
                  <div className="bg-background/40 p-3.5 rounded-2xl border border-secondary/5">
                    ...
                    <span className={`inline-block px-3 py-1 rounded-lg text-xs font-black uppercase tracking-wider ${pacienteActivo.estado === 'Tratamiento Activo' ? 'bg-blue-100 text-blue-700' :
                ...
                <div className="space-y-2 pt-2 border-t border-secondary/10">
                  <Link
                    ...
                    className="w-full bg-linear-to-rrom-emerald-500 to-teal-600 text-white py-3 rounded-2xl font-black text-[9px] uppercase tracking-widest shadow-lg hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
                  >
            ...
            <div className="w-full xl:w-2/3 bg-white rounded-2xl shadow-sm border border-secondary/20 flex flex-col overflow-hidden">
              ...
              <div className="flex flex-row border-b border-secondary/20 bg-background/30 shrink-0">
                <button
                  ...
                  className={`flex-1 py-3 md:py-4 font-black text-[9px] md:text-[10px] uppercase tracking-widest md:tracking-[0.2em] flex items-center justify-center gap-2 md:gap-3 transition-all ${pestañaActiva === 'evolucion' ? 'bg-white text-primary border-b-4 border-primary' : 'text-text-light hover:bg-white/50 opacity-60'}`}
                >
                ...
                <button
                  ...
                  className={`flex-1 py-3 md:py-4 font-black text-[9px] md:text-[10px] uppercase tracking-widest md:tracking-[0.2em] flex items-center justify-center gap-2 md:gap-3 transition-all ${pestañaActiva === 'archivos' ? 'bg-white text-primary border-b-4 border-accent-orange' : 'text-text-light hover:bg-white/50 opacity-60'}`}
                >
              ...
              <div className="flex-1 overflow-y-auto p-6 bg-slate-50/20 custom-scrollbar">
                ...
                {pestañaActiva === 'evolucion' && (
                  <div className="space-y-5">
                    ...
                    <div className="bg-background/30 p-5 rounded-4xl border border-secondary/10 shadow-sm">
                      ...
                      <div className="flex justify-end mt-3">
                        <button
                          ...
                          className="w-full md:w-auto flex justify-center items-center gap-2 bg-linear-to-r from-primary to-[#3a2e25] text-white px-6 py-3 md:py-2.5 rounded-2xl font-black text-[9px] uppercase tracking-widest shadow-lg hover:shadow-xl active:scale-95 transition-all disabled:opacity-40"
                        >
