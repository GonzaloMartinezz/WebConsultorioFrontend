...
const AcercaDe = () => {
  ...
  return (
    <main className="grow flex flex-col overflow-hidden relative">
      ...
      {/* ══════════════════════════════════════════════════════════
          HERO OSCURO — Réplica de "ODONTO_CORE" (image copy 3)
          ══════════════════════════════════════════════════════════ */}
      <section className="relative bg-[#0D0D0D] text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-10 lg:pt-28 lg:pb-16 relative z-10">
          {/* Status badge */}
