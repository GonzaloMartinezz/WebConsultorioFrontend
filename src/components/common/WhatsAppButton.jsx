      ...
      {isOpen && (
        ...
        >
          <div className="bg-[#25D366] text-white p-4 relative">
            <h3 className="font-bold text-lg mb-1 uppercase tracking-wide text-orange-500">Centro Odontológico C & M</h3>
            <p className="text-sm opacity-100 font-semibold text-black">Complete los datos para contactarnos y así poder consultarnos cualquier información.Recorda que para solicitar un turno debes inicar sesion.</p>
            <button
              onClick={toggleOpen}
