            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10">
                ...
                <div>
                  ...
                  <a href="https://wa.me/5493816242482" className="text-white font-bold text-sm hover:text-green-400 transition-colors">+54 9 381 624-2482</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10">
                ...
                <div>
                  ...
                  <a href="https://instagram.com/c.o_carcaramartinez" className="text-white font-bold text-sm hover:text-pink-400 transition-colors">@c.o_carcaramartinez</a>
                </div>
              </div>
            </div>
          </div>
