        ...
        <div className="bg-primary/10 backdrop-blur-3xl rounded-[3rem] p-10 md:p-20 shadow-[0_40px_100px_-20px_rgba(0,0,0,1)] border border-white/5 relative overflow-hidden group">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center relative z-10">
            ...
            <div className="w-full lg:w-5/12 space-y-8 text-center lg:text-left">
              <span className="inline-block px-5 py-2 rounded-full border border-accent-orange/30 bg-accent-orange/5 text-accent-orange font-black text-[10px] uppercase tracking-[0.3em] backdrop-blur-md">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[0.9] uppercase tracking-tighter">
                Tu Salud <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-accent-orange to-orange-500">A Un Clic</span>
              </h2>
              ...
              <div className="pt-4 flex justify-center lg:justify-start">
                <Link to="/login" className="group relative inline-flex items-center justify-center gap-3 bg-linear-to-r from-accent-orange to-orange-600 text-white font-black px-10 py-5 rounded-full uppercase text-sm tracking-widest shadow-[0_10px_30px_rgba(255,120,0,0.3)] hover:shadow-[0_15px_50px_rgba(255,120,0,0.5)] active:scale-95 transition-all overflow-hidden w-full sm:w-auto">
            ...
            <div className="w-full lg:w-7/12">
              <div className="bg-black/40 backdrop-blur-2xl rounded-[2.5rem] p-10 border border-white/10 shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-transparent via-accent-orange/50 to-transparent"></div>
                
                <h3 className="text-sm font-black text-accent-orange mb-10 uppercase tracking-[0.2em]">En nuestra plataforma podrás:</h3>
                
                <ul className="space-y-8">
                  <li className="flex items-start gap-6 group/item">
                    <div className="bg-white/5 p-4 rounded-2xl border border-white/10 shadow-lg text-accent-orange group-hover/item:border-accent-orange/50 group-hover/item:bg-accent-orange/10 transition-all duration-300">
                      <Hospital size={24} />
                    </div>
                    <div>
