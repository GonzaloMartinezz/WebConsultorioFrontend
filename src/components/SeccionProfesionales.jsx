            ...
            <div className="w-full max-w-6xl bg-[#4A3B32] rounded-[3rem] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12 shadow-2xl relative overflow-hidden">
                ...
                <div className="flex-1 flex flex-col gap-6 w-full max-w-md relative z-10">
                    <div className="text-center md:text-right mb-2">
                        <span className="text-white/50 text-xs font-bold tracking-[0.2em] uppercase bg-white/5 px-4 py-2 flex items-center justify-center rounded-full border border-white/10">
                            Especialistas
                        </span>
                    </div>

                    {/* Tarjeta Dra. Erina */}
                    <Link to="/especialistas/erina" className="bg-white rounded-full p-3 pr-8 flex items-center gap-5 shadow-xl hover:scale-[1.02] transition-transform cursor-pointer block">
                    ...
                    {/* Tarjeta Dr. Adolfo */}
                    <Link to="/especialistas/adolfo" className="bg-white rounded-full p-3 pr-8 flex items-center gap-5 shadow-xl hover:scale-[1.02] transition-transform cursor-pointer block">
                        <div className="w-16 h-16 bg-orange-50 rounded-full flex items-center justify-center shrink-0 border border-orange-100">
                            <span className="text-2xl">👨‍⚕️</span>
                        </div>
                        <div>
                            <h3 className="font-black text-primary text-lg leading-tight uppercase">Dr. Adolfo Alejandro Martinez</h3>
